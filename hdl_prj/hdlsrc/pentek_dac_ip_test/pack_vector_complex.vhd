-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\pack_vector_complex.vhd
...
END pack_vector_complex;


ARCHITECTURE rtl OF pack_vector_complex IS
...
BEGIN
  ...
  pack_vector_complex_1_output : PROCESS (u_im_signed, u_re_signed)
  ...
  END PROCESS pack_vector_complex_1_output;
