-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\Vector_NCO.vhd
...
ARCHITECTURE rtl OF Vector_NCO IS

  -- Component Declarations
  COMPONENT For_Each_Subsystem
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          inc                             :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : For_Each_Subsystem
    USE ENTITY work.For_Each_Subsystem(rtl);
