-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_ip_src_WaveformGen.vhd
...
ENTITY DAC_NCO_4_ip_src_WaveformGen IS
...
END DAC_NCO_4_ip_src_WaveformGen;


ARCHITECTURE rtl OF DAC_NCO_4_ip_src_WaveformGen IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_ip_src_LookUpTableGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DAC_NCO_4_ip_src_LookUpTableGen
    USE ENTITY work.DAC_NCO_4_ip_src_LookUpTableGen(rtl);
...
BEGIN
  u_CosineWave_inst : DAC_NCO_4_ip_src_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_SineWave_inst : DAC_NCO_4_ip_src_LookUpTableGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
