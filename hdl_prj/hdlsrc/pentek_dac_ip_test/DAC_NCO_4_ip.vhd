-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_ip.vhd
...
ARCHITECTURE rtl OF DAC_NCO_4_ip IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_ip_reset_sync
  ...
  COMPONENT DAC_NCO_4_ip_axi_lite
  ...
  COMPONENT DAC_NCO_4_ip_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  COMPONENT DAC_NCO_4_ip_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DAC_NCO_4_ip_reset_sync
    USE ENTITY work.DAC_NCO_4_ip_reset_sync(rtl);

  FOR ALL : DAC_NCO_4_ip_axi_lite
    USE ENTITY work.DAC_NCO_4_ip_axi_lite(rtl);

  FOR ALL : DAC_NCO_4_ip_axi4_stream_slave
    USE ENTITY work.DAC_NCO_4_ip_axi4_stream_slave(rtl);

  FOR ALL : DAC_NCO_4_ip_dut
    USE ENTITY work.DAC_NCO_4_ip_dut(rtl);

  FOR ALL : DAC_NCO_4_ip_axi4_stream_master
    USE ENTITY work.DAC_NCO_4_ip_axi4_stream_master(rtl);
  ...
  SIGNAL write_nco_phase_inc_reg          : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL write_src_sel_reg                : std_logic;  -- ufix1
...
BEGIN
  u_DAC_NCO_4_ip_reset_sync_inst : DAC_NCO_4_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DAC_NCO_4_ip_axi_lite_inst : DAC_NCO_4_ip_axi_lite
  ...
  u_DAC_NCO_4_ip_axi4_stream_slave_inst : DAC_NCO_4_ip_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DAC_NCO_4_ip_dut_inst : DAC_NCO_4_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_DAC_NCO_4_ip_axi4_stream_master_inst : DAC_NCO_4_ip_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= to_unsigned(2009151755, 32);
