-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_fixed_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DAC_NCO_4_fixed_ip_axi_lite
-- Source Path: DAC_NCO_4_fixed_ip/DAC_NCO_4_fixed_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DAC_NCO_4_fixed_ip_axi_lite IS
...
END DAC_NCO_4_fixed_ip_axi_lite;


ARCHITECTURE rtl OF DAC_NCO_4_fixed_ip_axi_lite IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_fixed_ip_addr_decoder
  ...
  COMPONENT DAC_NCO_4_fixed_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DAC_NCO_4_fixed_ip_addr_decoder
    USE ENTITY work.DAC_NCO_4_fixed_ip_addr_decoder(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_axi_lite_module
    USE ENTITY work.DAC_NCO_4_fixed_ip_axi_lite_module(rtl);
...
BEGIN
  u_DAC_NCO_4_fixed_ip_addr_decoder_inst : DAC_NCO_4_fixed_ip_addr_decoder
  ...
  u_DAC_NCO_4_fixed_ip_axi_lite_module_inst : DAC_NCO_4_fixed_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
