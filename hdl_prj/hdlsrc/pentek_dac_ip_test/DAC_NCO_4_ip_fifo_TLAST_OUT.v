// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_ip_fifo_TLAST_OUT.v
...
module DAC_NCO_4_ip_fifo_TLAST_OUT
  ...
  DAC_NCO_4_ip_SimpleDualPortRAM_singlebit #(.AddrWidth(2),
                                             .DataWidth(1)
                                             )
                                           u_DAC_NCO_4_ip_fifo_TLAST_OUT_classic_ram_singlebit (.clk(clk),
                                                                                                .enb(enb),
                                                                                                .wr_din(In),  // ufix1
                                                                                                .wr_addr(w_waddr),
                                                                                                .wr_en(w_we),  // ufix1
...
endmodule  // DAC_NCO_4_ip_fifo_TLAST_OUT
