-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_ip_reset_sync.vhd
...
ENTITY DAC_NCO_4_ip_reset_sync IS
  PORT( clk                               :   IN    std_logic;
        reset_in                          :   IN    std_logic;  -- ufix1
        reset_out                         :   OUT   std_logic  -- ufix1
        );
END DAC_NCO_4_ip_reset_sync;


ARCHITECTURE rtl OF DAC_NCO_4_ip_reset_sync IS
