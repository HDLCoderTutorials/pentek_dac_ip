-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_ip_src_NCO_HDL_Optimized4.vhd
...
ENTITY DAC_NCO_4_ip_src_NCO_HDL_Optimized4 IS
...
END DAC_NCO_4_ip_src_NCO_HDL_Optimized4;


ARCHITECTURE rtl OF DAC_NCO_4_ip_src_NCO_HDL_Optimized4 IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_ip_src_WaveformGen
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DAC_NCO_4_ip_src_WaveformGen
    USE ENTITY work.DAC_NCO_4_ip_src_WaveformGen(rtl);
...
BEGIN
  u_Wave_inst : DAC_NCO_4_ip_src_WaveformGen
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
