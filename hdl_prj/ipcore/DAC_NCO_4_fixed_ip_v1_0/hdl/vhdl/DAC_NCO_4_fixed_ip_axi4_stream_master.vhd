-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_fixed_ip_axi4_stream_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DAC_NCO_4_fixed_ip_axi4_stream_master
-- Source Path: DAC_NCO_4_fixed_ip/DAC_NCO_4_fixed_ip_axi4_stream_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DAC_NCO_4_fixed_ip_axi4_stream_master IS
...
END DAC_NCO_4_fixed_ip_axi4_stream_master;


ARCHITECTURE rtl OF DAC_NCO_4_fixed_ip_axi4_stream_master IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_fixed_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DAC_NCO_4_fixed_ip_fifo_TLAST_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : DAC_NCO_4_fixed_ip_fifo_data_OUT
    USE ENTITY work.DAC_NCO_4_fixed_ip_fifo_data_OUT(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_fifo_TLAST_OUT
    USE ENTITY work.DAC_NCO_4_fixed_ip_fifo_TLAST_OUT(rtl);
...
BEGIN
  u_DAC_NCO_4_fixed_ip_fifo_data_OUT_inst : DAC_NCO_4_fixed_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_DAC_NCO_4_fixed_ip_fifo_TLAST_OUT_inst : DAC_NCO_4_fixed_ip_fifo_TLAST_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
