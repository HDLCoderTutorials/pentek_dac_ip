-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_fixed_ip.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DAC_NCO_4_fixed_ip
-- Source Path: DAC_NCO_4_fixed_ip
-- Hierarchy Level: 0
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END DAC_NCO_4_fixed_ip;


ARCHITECTURE rtl OF DAC_NCO_4_fixed_ip IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_fixed_ip_reset_sync
  ...
  COMPONENT DAC_NCO_4_fixed_ip_axi_lite
  ...
  COMPONENT DAC_NCO_4_fixed_ip_axi4_stream_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Slave_TDATA         :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
  ...
  COMPONENT DAC_NCO_4_fixed_ip_dut
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
  ...
  COMPONENT DAC_NCO_4_fixed_ip_axi4_stream_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Master_TREADY       :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DAC_NCO_4_fixed_ip_reset_sync
    USE ENTITY work.DAC_NCO_4_fixed_ip_reset_sync(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_axi_lite
    USE ENTITY work.DAC_NCO_4_fixed_ip_axi_lite(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_axi4_stream_slave
    USE ENTITY work.DAC_NCO_4_fixed_ip_axi4_stream_slave(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_dut
    USE ENTITY work.DAC_NCO_4_fixed_ip_dut(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_axi4_stream_master
    USE ENTITY work.DAC_NCO_4_fixed_ip_axi4_stream_master(rtl);
...
BEGIN
  u_DAC_NCO_4_fixed_ip_reset_sync_inst : DAC_NCO_4_fixed_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_DAC_NCO_4_fixed_ip_axi_lite_inst : DAC_NCO_4_fixed_ip_axi_lite
  ...
  u_DAC_NCO_4_fixed_ip_axi4_stream_slave_inst : DAC_NCO_4_fixed_ip_axi4_stream_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_DAC_NCO_4_fixed_ip_dut_inst : DAC_NCO_4_fixed_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
  ...
  u_DAC_NCO_4_fixed_ip_axi4_stream_master_inst : DAC_NCO_4_fixed_ip_axi4_stream_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= to_unsigned(2009081347, 32);
  ...
  top_user_valid <= m_axis_valid_sig;

  s_axis_valid_sig <= top_user_valid_1;
