-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_fixed_ip_src_DAC_NCO_4xSampling_IQ.vhd
...
-- -------------------------------------------------------------
-- m_axis_data                   ce_out        8e-09
-- m_axis_valid                  ce_out        8e-09
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
-- -------------------------------------------------------------
-- 
-- Module: DAC_NCO_4_fixed_ip_src_DAC_NCO_4xSampling_IQ
...
ENTITY DAC_NCO_4_fixed_ip_src_DAC_NCO_4xSampling_IQ IS
...
END DAC_NCO_4_fixed_ip_src_DAC_NCO_4xSampling_IQ;


ARCHITECTURE rtl OF DAC_NCO_4_fixed_ip_src_DAC_NCO_4xSampling_IQ IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_fixed_ip_src_Vector_NCO
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT DAC_NCO_4_fixed_ip_src_Pack_Complex_Vector
  ...
  COMPONENT DAC_NCO_4_fixed_ip_src_To_Data_Bus1
  ...
  COMPONENT DAC_NCO_4_fixed_ip_src_To_Data_Bus
    PORT( data                            :   IN    std_logic_vector(127 DOWNTO 0);  -- ufix128
          valid                           :   IN    std_logic;
          bus_data                        :   OUT   std_logic_vector(127 DOWNTO 0);  -- ufix128
          bus_valid                       :   OUT   std_logic
  ...
  FOR ALL : DAC_NCO_4_fixed_ip_src_Vector_NCO
    USE ENTITY work.DAC_NCO_4_fixed_ip_src_Vector_NCO(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_src_Pack_Complex_Vector
    USE ENTITY work.DAC_NCO_4_fixed_ip_src_Pack_Complex_Vector(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_src_To_Data_Bus1
    USE ENTITY work.DAC_NCO_4_fixed_ip_src_To_Data_Bus1(rtl);

  FOR ALL : DAC_NCO_4_fixed_ip_src_To_Data_Bus
    USE ENTITY work.DAC_NCO_4_fixed_ip_src_To_Data_Bus(rtl);
...
BEGIN
  ...
  u_Vector_NCO : DAC_NCO_4_fixed_ip_src_Vector_NCO
    PORT MAP( clk => clk,
              reset => reset,
              enb => clk_enable,
  ...
  u_Pack_Complex_Vector : DAC_NCO_4_fixed_ip_src_Pack_Complex_Vector
    PORT MAP( u_re => Vector_NCO_out1_re,  -- sfix16_En15 [4]
              u_im => Vector_NCO_out1_im,  -- sfix16_En15 [4]
              y => y  -- ufix128
              );

  u_To_Data_Bus1 : DAC_NCO_4_fixed_ip_src_To_Data_Bus1
  ...
  u_To_Data_Bus : DAC_NCO_4_fixed_ip_src_To_Data_Bus
