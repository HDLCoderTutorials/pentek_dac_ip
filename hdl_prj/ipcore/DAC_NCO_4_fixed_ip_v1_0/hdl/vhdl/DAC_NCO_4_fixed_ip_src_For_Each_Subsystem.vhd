-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\pentek_dac_ip_test\DAC_NCO_4_fixed_ip_src_For_Each_Subsystem.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DAC_NCO_4_fixed_ip_src_For_Each_Subsystem
...
ENTITY DAC_NCO_4_fixed_ip_src_For_Each_Subsystem IS
...
END DAC_NCO_4_fixed_ip_src_For_Each_Subsystem;


ARCHITECTURE rtl OF DAC_NCO_4_fixed_ip_src_For_Each_Subsystem IS

  -- Component Declarations
  COMPONENT DAC_NCO_4_fixed_ip_src_NCO_HDL_Optimized4
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          inc                             :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
  ...
  FOR ALL : DAC_NCO_4_fixed_ip_src_NCO_HDL_Optimized4
    USE ENTITY work.DAC_NCO_4_fixed_ip_src_NCO_HDL_Optimized4(rtl);
...
BEGIN
  u_NCO_HDL_Optimized4 : DAC_NCO_4_fixed_ip_src_NCO_HDL_Optimized4
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              inc => inc,  -- uint32
